...
{\footnotesize $^{*}$Average path lengths are estimated by sampled BFS (500 sources) on the giant component; the ER value is consistent with the analytical estimate $\ln n / \ln \langle k\rangle \approx 1.8$.}
