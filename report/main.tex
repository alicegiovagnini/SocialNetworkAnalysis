...
\input{Part0Introduction}
\input{Part1DataCollection}
\input{Part2NetworkCharacterization}
\input{Part3NetworkManipulationAndAnalysis}
\input{Part4OpenQuestion}
