...
\begin{itemize}
    \item Seed dependence: the sample characterises the community around the seeds, not the whole platform, and the manual, heuristic seed choice influences the observed structure.
